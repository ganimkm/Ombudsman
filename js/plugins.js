$(function() {
    ...
    var uiElements = function(){
        ...
        var uiDatatable = function(){
            ...
            if($(".datatable_scrollbar").length > 0){                
                $(".datatable_scrollbar").dataTable({"scrollX": true,"ordering": false});
                $(".datatable_scrollbar").on('page.dt',function () {
                    onresize(100);
                });       
            }
            
            if($(".datatable_nopaging").length > 0){                
                $(".datatable_nopaging").dataTable({"scrollX": true,"ordering": true,"paging":false});
                $(".datatable_nopaging").on('page.dt',function () {
                    onresize(100);
                });       
            }
