            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">                                
                        <h3 class="panel-title"><strong>Impact</strong></h3>
                            ...
                            <tbody>
                                <?php
                                    foreach($impact as $row)
                                    {
                                        ...
                                        <a href="'.site_url("helpdesk/general").'/impact/update/'.$row['impact_id'].'" class="btn btn-primary btn-rounded btn-xs"><span class="fa fa-pencil"></span></a>  
                                        <a href="'.site_url("helpdesk/general").'/impact/delete/'.$row['impact_id'].'" class="btn btn-danger btn-rounded btn-xs" onclick="return confirmDialog();"><span class="fa fa-times"></span></a>
                                        </td>';
                                        echo '</tr>';
                                    }
                                ?>        
