                            ...
                            <tbody>
                                <?php
                                    foreach($sub_category as $row)
                                    {
                                        ...
                                        <a href="'.site_url("helpdesk/general").'/subcategory/update/'.$row['sub_category_id'].'" class="btn btn-primary btn-rounded btn-xs"><span class="fa fa-pencil"></span></a>  
                                        <a href="'.site_url("helpdesk/general").'/subcategory/delete/'.$row['sub_category_id'].'" class="btn btn-danger btn-rounded btn-xs" onclick="return confirmDialog();"><span class="fa fa-times"></span></a>
                                        </td>';
                                        echo '</tr>';
                                    }
                                ?>        
