                ...
                <form class="form-horizontal">
                    ...
                    <div class="panel panel-default">
                        ...
                        <div class="panel-heading">
                            <h3 class="panel-title"><strong>Updating</strong> Category</h3>
                        ...
                        <div class="panel-body">                                                                        
                            ...
                            <div class="form-group">                                        
                                ...
                                <div class="col-md-2 col-xs-12">
                                    <input type="text" class="form-control" name="category_id" id="category_id" placeholder="Category ID" value="<?php echo $category[0]['category_id']; ?>"/>                          
                            ...
                            <div class="form-group">                                        
                                ...
                                <div class="col-md-3 col-xs-12">
                                    <input type="text" class="form-control" name="category_description" id="category_description" placeholder="Description" value="<?php echo $category[0]['category_description']; ?>"/>                                      
                                    <span class="help-block">Required</span>
                                </div>
                            </div>
