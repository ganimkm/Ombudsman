            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">                                
                        <h3 class="panel-title"><strong>Accept</strong> Incident</h3>
                        <button id="accept" class="btn btn-info btn-rounded pull-right"><span class="fa fa-check-square-o"></span>Accept Selected</button>
                    </div>
                            ...
                            <tbody>
                                <?php
                                    foreach($incident as $row)
                                    {
                                        ...
                                        echo '<td><input type="checkbox" name="incidentnumber" value="'.$row['incident_number'].'"></td>';
...
<!--                    <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#modal-content">Open Modal</button>-->
...
function CheckAll(source) {
  ...
  checkboxes = document.getElementsByName('incidentnumber');
...
$(function(){
    ...
    $('#accept').click(function(){
        ...
        var selectedincidentnumber ="" ;

        $("input:checkbox[name=incidentnumber]:checked").each(function () {
            //alert($(this).val());
            selectedincidentnumber += ($(this).val()) + ","
        });
      
       if (selectedincidentnumber == ''){
            alert("Select the incident(s)");
            exit();
        }
            
        selectedincidentnumber =  selectedincidentnumber.substring(0, selectedincidentnumber.length - 1);

        var post_url = "<?php echo site_url() ?>/helpdesk/ticket/IncidentController/Accept_Incident" 
        var dataString = 'incident_number=' + selectedincidentnumber  
            ...
            $.ajax(
            {
                ...
                success: function(acceptincident) //we're calling the response json array 'nwdowntime'
...
//<input type="checkbox" name="Interested" value="Insurnace" />Insurnace
//<br />
//<input type="checkbox" name="Interested" value="Electricity" />Electricity
//<br />
//<input type="checkbox" name="Interested" value="Mortgage" />Mortgage
//<br />
//<input type="checkbox" name="Interested" value="Gas" />Gas
//
