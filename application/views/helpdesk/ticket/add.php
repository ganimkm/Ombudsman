...
<!--                            <ul class="panel-controls">
                        ...
                        <div class="panel-body">                                                                        
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-md-2 col-xs-12">
                                    <input type="text" class="form-control" name="email_address" id="email_address" placeholder="Email_Address" value="<?php echo $user[0]['email_address'];?>"/>                      
                                </div>
                            </div>   
                            ...
                            <div class="form-group">                
                                ...
                                <?php  
                                    if (!empty($auto_log_incidents)) {
                                        
                                        $additional_parameters = json_decode($auto_log_incidents[0]['additional_parameters'], true);
                                        
                                         /*if(array_key_exists('request_type_id', $additional_parameters)) {
                                             
                                            //print_r($request_type);
                                             
                                            //echo $additional_parameters['request_type_id'];
                                             
                                            //sort($request_type);
                                            //$key = array_search($additional_parameters['request_type_id'],array_column($request_type,'request_type_id'));
                                                
                                            //$key = array_search($additional_parameters['request_type_id'], $request_type); 
                                            //printf($key);                                                          
                                            
                                            
                                            $key = array_search($additional_parameters['request_type_id'],array_column($request_type,'request_type_id'));
                                            echo ($request_type[$key]['request_type_description'])  ;
                                    ...
                                    <div class="col-sm-2">
                                        <select id="category" name="category" class="form-control select">
                                            ...
                                            <?php
                                                ...
                                                if(array_key_exists('category_id', $additional_parameters)) {

                                                    $key = array_search($additional_parameters['category_id'],array_column($category,'category_id'));
                                                    echo '<option value="' . $additional_parameters['category_id'] . '">' . $category[$key]['category_description'] . '</option>';
                                                }
                                    ...
                                    <div class="col-sm-2">
                                        <select id="sub_category" name="sub_category" class="form-control">
                                            ...
                                            <?php
                                                ...
                                                if(array_key_exists('sub_category_id', $additional_parameters)) {

                                                    $key = array_search($additional_parameters['sub_category_id'],array_column($sub_category,'sub_category_id'));
                                                    echo '<option value="' . $additional_parameters['sub_category_id'] . '">' . $sub_category[$key]['sub_category_description'] . '</option>';
                                                }
                                    ...
                                    <select id="request_type" name="request_type" class="form-control select">  
                                        ...
                                        <?php
                                            ...
                                            if(array_key_exists('request_type_id', $additional_parameters)) {
                                                ...
                                                $key = array_search($additional_parameters['request_type_id'],array_column($request_type,'request_type_id'));
                                                echo '<option value="' . $additional_parameters['request_type_id'] . '">' . $request_type[$key]['request_type_description'] . '</option>';
                                            }
                                ...
                                <div class="col-sm-2">        
                                    ...
                                    <select id="call_mode" name="call_mode" class="form-control select">
                                        ...
                                        <?php
                                            ...
                                            if(array_key_exists('call_mode_id', $additional_parameters)) {

                                                $key = array_search($additional_parameters['call_mode_id'],array_column($call_mode,'call_mode_id'));
                                                echo '<option value="' . $additional_parameters['call_mode_id'] . '">' . $call_mode[$key]['call_mode_description'] . '</option>';
                                            }
                                ...
                                <div class="col-md-2 col-xs-12">      
                                    ...
                                    <select id="business_criteria" name="business_criteria" class="form-control select">
                                        ...
                                        <?php
                                            ...
                                            if(array_key_exists('business_criteria_id', $additional_parameters)) {

                                                $key = array_search($additional_parameters['business_criteria_id'],array_column($business_criteria,'business_criteria_id'));
                                                echo '<option value="' . $additional_parameters['business_criteria_id'] . '">' . $business_criteria[$key]['business_criteria_description'] . '</option>';
                                            }
                                ...
                                <div class="col-sm-2">     
                                    ...
                                    <select id="business_classification" name="business_classification" class="form-control select">
                                        ...
                                        <?php
                                            ...
                                            if(array_key_exists('business_classification_id', $additional_parameters)) {

                                                $key = array_search($additional_parameters['business_classification_id'],array_column($business_classification,'business_classification_id'));
                                                echo '<option value="' . $additional_parameters['business_classification_id'] . '">' . $business_classification[$key]['business_classification_description'] . '</option>';
                                            }
                                ...
                                <div class="col-md-2 col-xs-12">                                                                                          
                                    <select id="impact" name="impact" class="form-control select">
                                        ...
                                        <?php
                                            ...
                                            if(array_key_exists('impact_id', $additional_parameters)) {

                                                $key = array_search($additional_parameters['impact_id'],array_column($impact,'impact_id'));
                                                echo '<option value="' . $additional_parameters['impact_id'] . '">' . $impact[$key]['impact_description'] . '</option>';
                                            }
                                ...
                                <div class="col-md-3 col-xs-12">   
                                    ...
                                    <select id="impact_classification" name="impact_classification" class="form-control select">
                                        ...
                                        <?php
                                            ...
                                            if(array_key_exists('impact_classification_id', $additional_parameters)) {

                                                $key = array_search($additional_parameters['impact_classification_id'],array_column($impact_classification,'impact_classification_id'));
                                                echo '<option value="' . $additional_parameters['impact_classification_id'] . '">' . $impact_classification[$key]['impact_classification_description'] . '</option>';
                                            }
                                ...
                                <div class="col-md-2 col-xs-12">                                                                                            
                                    <select id="assigned_to" name="assigned_to" class="form-control select">
                                        ...
                                        <?php
                                            ...
                                            if(array_key_exists('assigned_to', $additional_parameters)) {

                                                $key = array_search($additional_parameters['assigned_to'],array_column($assigned_to,'user_id'));
                                                echo '<option value="' . $additional_parameters['assigned_to'] . '">' . $assigned_to[$key]['user_name'] . '</option>';
                                            }
