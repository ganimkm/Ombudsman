   <!-- START BREADCRUMB -->     
    ...
    <?php
      ...
      echo form_open('helpdesk/ticket/hold/'.$this->uri->segment(4).'', $attributes);
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Hold</strong> Incident</h3>
                    ...
                    <div class="panel-body">                                                                        
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 col-xs-12 control-label">Hold on</label>  
                                     <div class="col-md-3 col-xs-12">
                                        <input type="text" class="form-control datepicker" name="hold_on_date" id="hold_on_date" placeholder="Date" value="<?php set_value('hold_on_date')?>"/>                        
                                        <span class="help-block">Required</span>
                                    </div>
                                     <div class="col-md-2 col-xs-12">
                                        <input type="text" class="form-control" name="hold_on_time"  id="hold_on_time" placeholder="Time" value="<?php set_value('hold_on_time')?>"/>   
                                        <span class="help-block">Required</span>
                                    </div>
                                </div> 

                                <div class="form-group">
                                    <label class="col-md-3 col-xs-12 control-label">Hold Reason</label>
                                    <div class="col-md-4 col-xs-12">                                                                                            
                                        <select id="hold_reason" name="hold_reason" class="form-control select">
                                            <option value="">Select</option>
                                            <?php foreach($holdreason as $row) { echo '<option value="' . $row['hold_reason_id'] . '">' . $row['hold_reason_description'] . '</option>'; } ?>
                                        </select>
                                        <span class="help-block">Required</span>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <label class="col-md-3 control-label">Hold Description</label>
                                    <div class="col-md-9 col-xs-12">  
                                        <textarea class="form-control" id="hold_description" required  name="hold_description" placeholder="Description" rows="3" value="<?php echo set_value('resolved_description'); ?>"></textarea>
                                        <span class="help-block">Required</span>
                                    </div>
                                </div>
...
<script type="text/javascript">
    ...
    {  
        $("#hold_on_date").attr("value", "<?php echo date("Y-m-d") ?>");
        $("#hold_on_time").attr("value", "<?php echo date("H:i:s") ?>");
    });
