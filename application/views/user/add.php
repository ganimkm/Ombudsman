    ...
    //flash messages
        if(isset($flash_message)){
            if($flash_message == TRUE){
                ...
                echo '<strong>Well done!</strong> new ' . ucfirst('User') . ' created with success.';
                echo '</div>';       
            }else{
            ...
            <div class="col-md-12">
                ...
                <div class="panel panel-default">
                    ...
                    <div class="panel-heading">
                        <h3 class="panel-title"><strong>Adding</strong> User</h3>
                    ...
                    <div class="panel-body">                                                                        
                        ...
                        <div class="form-group">                                        
                            ...
                            <div class="col-md-3 col-xs-12">
                                <input type="text" class="form-control" name="user_name" id="user_name" placeholder="User Name" value="<?php echo set_value('user_name'); ?>"/>                                        
                                <span class="help-block">Required</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">                                        
                            ...
                            <div class="col-md-3 col-xs-12">
                                <input type="text" class="form-control" name="mobile_number" id="mobile_number" placeholder="Mobile Number" value="<?php echo set_value('mobile_number'); ?>"/>                                        
                                <span class="help-block">Required</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">                                        
                            ...
                            <div class="col-md-3 col-xs-12">
                                <input type="text" class="form-control" name="designation" id="designation" placeholder="Designation" value="<?php echo set_value('designation'); ?>"/>                                        
                                <span class="help-block">Required</span>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-xs-12">
                                <label class="radio-inline">
                                    <input type="radio" class="iradio" name="is_active" value="1" <?=set_radio('is_active', 1, True)?> />Yes
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" class="iradio" name="is_active" value="0" <?=set_radio('is_active', 0)?> />No
                                </label>
                            </div>    
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-xs-12">
                                <label class="radio-inline">
                                    <input type="radio" class="iradio" name="is_admin" value="1" <?=set_radio('is_admin', 1)?> />Yes
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" class="iradio" name="is_admin" value="0" <?=set_radio('is_admin', 0,True)?> />No
                                </label>
                            </div>    
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-3 col-xs-12">
                                <label class="radio-inline">
                                    <input type="radio" class="iradio" name="is_ticket_resolver" value="1" <?=set_radio('is_ticket_resolver', 1)?> />Yes
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" class="iradio" name="is_ticket_resolver" value="0" <?=set_radio('is_ticket_resolver', 0,True)?> />No
                                </label>
                            </div>    
                        </div>
...
//        if (location_id != "")
//        {          
//            var post_url = "<?php echo site_url() ?>/helpdesk/general/DepartmentController/Get_Department"
